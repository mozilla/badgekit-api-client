...
function initModel (constructor, pathPart, prototype, inherits) {
  ...
  if (pathPart) {
    ...
    constructor.prototype._getPathPart = function getPathPart () {
      return pathPart + '/' + encodeURIComponent(this[constructor.pathIdentifier]);
    }
  }
  ...
  try {
    if (context instanceof models.BaseModel) {
      ...
      if (context.milestone) {
        if (!(currentContext instanceof models.System))
          doError('Milestone requires System parent context');

        currentContext = new models.Milestone(context.milestone, currentContext);
      }
      ...
      // this is to deprecate my silly mistake of naming the instance specifier "email" instead of "instance" originally.  Smart, erik.
      context.instance = context.instance || context.email;
      ...
      if (context.claimCode) {
        ...
        currentContext = new models.Instance(context.instance, currentContext);
      }
